defmodule PhoenixFrameworkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixFrameworkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixFrameworkWeb.Gettext, "errors", msg, opts)
    end
  end
